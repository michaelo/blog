...
export class AppBlog {
  ...
  async componentWillLoad() {
    // Look up posts.json
    const posts = (await (await fetch("/assets/posts.json")).json()) as BlogIndexEntry[];
    ...
    return [
      <div class="content-blog">
        ...
        {this.currentPost && <aside class="social">
          <h2>Diskuter</h2>
          <a target="_blank" href={`http://twitter.com/share?text=${this.currentPost.title}&url=${window.location.href}&hashtags=`} title="Diskuter på twitter">
